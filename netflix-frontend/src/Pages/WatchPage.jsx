...
// import { formatReleaseDate } from "../utils/dateFuncion";
// const WatchPage = () => {
// 	const { id } = useParams();
	...
	useEffect(() => {
		...
		setTimeout(() => {
			setContent({
				...
				name: "Dummy TV Show Name",
				release_date: "2023-06-15",
				first_air_date: "2023-06-01",
				adult: false,
				overview:
					"This is a dummy overview for the selected content. It is used for UI demonstration purposes.",
			...
			setSimilarContent([
				{ id: 1, title: "Similar Movie 1", poster_path: "/dummy1.jpg" },
				{ id: 2, title: "Similar Movie 2", poster_path: "/dummy2.jpg" },
				{ id: 3, title: "Similar Movie 3", poster_path: "/dummy3.jpg" },
			]);

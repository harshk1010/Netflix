...
const dummyContent = [
	...
	},
	{
		id: 2,
		title: "Breaking Bad",
		backdrop_path: "/breaking-bad.jpg",
	},
	{
		id: 3,
		title: "Oppenheimer",
		backdrop_path: "/oppenheimer.jpg",
	},
];
...
const MovieSlider = ({ category = "" }) => {
	...
	const formattedCategoryName = getFormattedCategoryName(category);
	const formattedContentType = contentType === "movie" ? "Movies" : "TV Shows";
	...
	useEffect(() => {
		const getContent = async () => {
			try {
				...
				setContent([]); // fallback to empty if API fails
			}
		};
